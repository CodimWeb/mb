...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  , ["content"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" <div v-if=\"error\" class=\"md:w-10/12 md:p-2 w-full mx-auto text-sm text-red-500 text-white text-center\">\n                {{error}}\n            </div> "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [$data.busy ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_circle_svg, {
    ...
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)('p-3 rounded-sm text-white' + (!_ctx.error ? ' bg-blue-500 hover:bg-blue-600' : ' bg-red-400 text-white hover:bg-red-600'))
